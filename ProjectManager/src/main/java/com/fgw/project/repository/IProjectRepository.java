...
public interface IProjectRepository extends JpaRepository<Project , Integer> {
	...
	@Query(value="SELECT "
			...
			+ " p.td_provide as tdProvide,p.td_is_bl as tdIsBl,p.td_handle_level as tdHandleLevel,p.td_is_sendappdepart as tdIsSendappdepart,p.td_bao as tdBao,p.td_bao_no_msg as tdBaoNoMsg,"
			...
			+ " p.other_bl as otherBl,p.diff_and_problem as diffAndProblem,p.pro_manager as proManager,p.pro_manager2 as proManager2 ,p.image,p.process_condition as processCondition,p.submitted,p.pro_manager_ting as proManagerTing,"
			+ " p.pro_manager_mobile as proManagerMobile,p.pro_manager_mobile2 as proManagerMobile2,p.enter_manager as enterManager,p.enter_manager_mobile as enterManagerMobile,p.stage,p.nopass,p.status,p.is_dispatch as isDispatch,p.complete_date as completeDate,   "
	...
	@Query(value="SELECT "
			...
			+ " p.rf_is_bl as rfIsBl,p.rf_handle_level as rfHandleLevel,p.rf_is_sendappdepart as rfIsSendappdepart,"
			+ " p.other_bl as otherBl,p.diff_and_problem as diffAndProblem,p.pro_manager as proManager,p.pro_manager2 as proManager2 ,p.image,p.process_condition as processCondition,p.submitted,p.pro_manager_ting as proManagerTing,"
			+ " p.pro_manager_mobile as proManagerMobile,p.pro_manager_mobile2 as proManagerMobile2,p.stage,p.nopass,p.status,p.is_dispatch as isDispatch,p.complete_date as completeDate,   "
	...
	@Query(value="SELECT "
			...
			+ " LEFT JOIN industry_category ic on ic.id = p.industry_category "
			+ " WHERE p.name like %:search% AND p.status =:status ",nativeQuery=true)
	List<Map<String, Object>> getAllProjectOfSearchStatus(@Param("status")Integer status,@Param("search")String search);
