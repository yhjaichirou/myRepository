package com.yhj.singlesign.utils;
...
//	}
	 ...
	 * @throws IllegalAccessException 
	 */
	public <T> List<List<Object>> importData2(List<String> colNames,List<T> datas) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		List<List<Object>> results = new ArrayList<>();
		if(colNames==null || colNames.size()==0||datas == null || datas.size() ==0) {
			return results;
		}
		for (T t : datas) {
			Method[] methods = t.getClass().getMethods();
	 ...
	 * @throws IllegalAccessException 
	 */
	public <T> List<Map<String,Object>> getClassFields(T t) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		Method[] methods = t.getClass().getMethods();
		//生成对象实例
		List<Map<String,Object>> target = new LinkedList<>();
		for (Method method : methods) {
			if (method.getName().startsWith("get")) {
